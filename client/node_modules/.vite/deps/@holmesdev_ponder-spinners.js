...
// node_modules/@holmesdev/ponder-spinners/dist/index.es.js
...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length2, siblings) {
  ...
  for (var i2 = 0, j2 = 0, k2 = 0; i2 < index; ++i2)
    for (var x3 = 0, y3 = substr(value, post + 1, post = abs(j2 = points[i2])), z2 = value; x3 < size; ++x3)
...
function prefix(value, length2, children) {
  switch (hash(value, length2)) {
    ...
    case 5152:
    case 5920:
      return replace(value, /(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/, function(_2, a2, b, c3, d2, e2, f3) {
        return MS + a2 + ":" + b + f3 + (c3 ? MS + a2 + "-span:" + (d2 ? e2 : +e2 - +b) + f3 : "") + value;
      });
    case 4949:
  ...
  if (true) {
    ...
    try {
      ...
      console.error = function(t3) {
        ...
        E.test(t3) ? (a2 = false, N.delete(s3)) : i2.apply(void 0, __spreadArray([t3], n3, false));
...
function oe(e2, t2, n2) {
  if ("string" != typeof t2) {
    ...
    var r3 = K(t2);
    Q && (r3 = r3.concat(Q(t2)));
    for (var s3 = X(e2), i2 = X(t2), a2 = 0; a2 < r3.length; ++a2) {
      var c3 = r3[a2];
...
var fe = function() {
  ...
  return e2.prototype.indexOfGroup = function(e3) {
    ...
    for (var i2 = this.indexOfGroup(e3 + 1), a2 = (s3 = 0, t2.length); s3 < a2; s3++) this.tag.insertRule(i2, t2[s3]) && (this.groupSizes[e3]++, i2++);
...
var Ne = function(e2, t2, n2) {
  for (var o3, r3 = n2.split(","), s3 = 0, i2 = r3.length; s3 < i2; s3++) (o3 = r3[s3]) && e2.registerName(t2, o3);
};
var Pe = function(e2, t2) {
  for (var n2, o3 = (null !== (n2 = t2.textContent) && void 0 !== n2 ? n2 : "").split(g), r3 = [], s3 = 0, i2 = o3.length; s3 < i2; s3++) {
    var a2 = o3[s3].trim();
    if (a2) {
      var c3 = a2.match(Ee);
      if (c3) {
    ...
    this.options = __assign(__assign({}, Te), e3), this.gs = n2, this.names = new Map(o3), this.server = !!e3.isServer, !this.server && S && Re && (Re = false, _e(this)), ue(this, function() {
      return function(e4) {
        for (var t2 = e4.getTag(), n3 = t2.length, o4 = "", r4 = function(n4) {
          ...
          var s4 = e4.names.get(r5), i2 = t2.getGroup(n4);
          if (void 0 === s4 || !s4.size || 0 === i2.length) return "continue";
          var a2 = "".concat(f, ".g").concat(n4, '[id="').concat(r5, '"]'), c3 = "";
          void 0 !== s4 && s4.forEach(function(e5) {
            e5.length > 0 && (c3 += "".concat(e5, ","));
          }), o4 += "".concat(i2).concat(a2, '{content:"').concat(c3, '"}').concat(g);
        }, s3 = 0; s3 < n3; s3++) r4(s3);
        return o4;
      }(r3);
    });
...
function Fe(e2) {
  var t2, n2, o3, r3 = void 0 === e2 ? C : e2, s3 = r3.options, i2 = void 0 === s3 ? C : s3, a2 = r3.plugins, c3 = void 0 === a2 ? _ : a2, l3 = function(e3, o4, r4) {
  ...
  var p3 = function(e3, r4, s4, a3) {
    void 0 === r4 && (r4 = ""), void 0 === s4 && (s4 = ""), void 0 === a3 && (a3 = "&"), t2 = a3, n2 = r4, o3 = new RegExp("\\".concat(n2, "\\b"), "g");
  ...
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.isStatic && !n2.hash) if (this.staticRulesId && t2.hasNameForId(this.componentId, this.staticRulesId)) o3 = ie(o3, this.staticRulesId);
      ...
      if (!t2.hasNameForId(this.componentId, s3)) {
        ...
        t2.insertRules(this.componentId, s3, i2);
      }
      o3 = ie(o3, s3), this.staticRulesId = s3;
    }
    else {
      for (var a2 = M(this.baseHash, n2.hash), c3 = "", l3 = 0; l3 < this.rules.length; l3++) {
...
function it(e2, r3, s3) {
  var i2 = se(e2), a2 = e2, c3 = !L(e2), p3 = r3.attrs, d2 = void 0 === p3 ? _ : p3, h2 = r3.componentId, f3 = void 0 === h2 ? function(e3, t2) {
  ...
  }(e2) : m3, g3 = r3.displayName && r3.componentId ? "".concat(R(r3.displayName), "-").concat(r3.componentId) : r3.componentId || f3, S2 = i2 && a2.attrs ? a2.attrs.concat(d2).filter(Boolean) : d2, w3 = r3.shouldForwardProp;
  ...
  var N2 = new Qe(s3, g3, i2 ? a2.componentStyle : void 0);
  function O2(e3, r4) {
    return function(e4, r5, s4) {
      var i3 = e4.attrs, a3 = e4.componentStyle, c4 = e4.defaultProps, p4 = e4.foldedComponentIds, d3 = e4.styledComponentId, h3 = e4.target, f4 = import_react.default.useContext(et), m4 = Ge(), y4 = e4.shouldForwardProp || m4.shouldForwardProp;
      (0, import_react.useDebugValue)(d3);
      var v2 = I(r5, f4, c4) || C, g4 = function(e5, n2, o3) {
        for (var r6, s5 = __assign(__assign({}, n2), { className: void 0, theme: o3 }), i4 = 0; i4 < e5.length; i4 += 1) {
          var a4 = re(r6 = e5[i4]) ? r6(s5) : r6;
      ...
      var N3 = ie(p4, d3);
      return E3 && (N3 += " " + E3), g4.className && (N3 += " " + g4.className), w4[L(S3) && !A.has(S3) ? "class" : "className"] = N3, w4.ref = s4, (0, import_react.createElement)(S3, w4);
    }(D2, e3, r4);
  }
  O2.displayName = y3;
  var D2 = import_react.default.forwardRef(O2);
  return D2.attrs = S2, D2.componentStyle = N2, D2.displayName = y3, D2.shouldForwardProp = w3, D2.foldedComponentIds = i2 ? ie(a2.foldedComponentIds, a2.styledComponentId) : "", D2.styledComponentId = g3, D2.target = i2 ? a2.target : e2, Object.defineProperty(D2, "defaultProps", { get: function() {
...
`;
  var t2;
    ...
    linear infinite;
  color: ${(e2) => e2.color};
  opacity: ${(e2) => e2.opacity};
`;
function l2({ color1: t2 = "#FF6F61", color2: n2 = "#ffa9a1", opacity1: r3 = 0.5, opacity2: i2 = 1, speed: a2 = "1s", direction: l3 = "-360deg", size: s3 = "100" }) {
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(o2, { xmlns: "http://www.w3.org/2000/svg", width: s3, height: s3, fill: "none", speed: a2, direction: l3, viewBox: "0 0 110 110" }, import_react2.default.createElement("path", { fill: t2, d: "M110 55c0 30.376-24.624 55-55 55S0 85.376 0 55 24.624 0 55 0s55 24.624 55 55Zm-92.85 0c0 20.904 16.946 37.85 37.85 37.85S92.85 75.904 92.85 55 75.904 17.15 55 17.15 17.15 34.096 17.15 55Z", opacity: r3 }), import_react2.default.createElement("path", { fill: n2, d: "M101.425 55c4.736 0 8.643-3.862 7.908-8.54A54.999 54.999 0 0 0 63.54.667C58.862-.068 55 3.84 55 8.575c0 4.736 3.887 8.478 8.502 9.542a37.843 37.843 0 0 1 18.262 10.119 37.85 37.85 0 0 1 10.119 18.262C92.947 51.113 96.689 55 101.425 55Z", opacity: i2 })));
}
l2.propTypes = { color1: import_prop_types.default.string, color2: import_prop_types.default.string, opacity1: import_prop_types.default.number, opacity2: import_prop_types.default.number, speed: import_prop_types.default.string, direction: import_prop_types.default.string, size: import_prop_types.default.string };
var s2 = mt`
	0%, 60%, 100% {
		transform: initial;
	}
...
`;
var c2 = dt.circle`
  animation: ${s2} 1.3s linear infinite;
...
`;
function m2({ colors: t2 = ["#22333B", "#FF6F61", "#B7AEA3"] }) {
  const n2 = Array.from({ length: t2.length });
  return import_react2.default.createElement(p2, { xmlns: "http://www.w3.org/2000/svg", width: "150", height: "150", viewBox: "0 0 100 100", fill: "none" }, n2.map((n3, r3) => import_react2.default.createElement(c2, { cx: 20 * (r3 + 1), cy: "49.5", r: "8", fill: t2[r3], key: r3 })));
}
m2.propTypes = { colors: import_prop_types.default.arrayOf(import_prop_types.default.string), duration: import_prop_types.default.string };
var d = mt`
  0%, 50%, 100% {
...
var x2 = dt.div`
  width: 100px;
  height: 100px;
  background-color: ${(e2) => e2.color || "#333"};
  border-radius: 12px;
  animation: ${d} 4s infinite ease-in-out;
  animation-delay: ${(e2) => e2.delay || "0s"};
`;
var g2 = ({ colors: t2 = ["#22333B", "#FF6F61", "#ffa9a1", "#22333B"] }) => import_react2.default.createElement(f2, null, import_react2.default.createElement(h, null, import_react2.default.createElement(x2, { color: t2[0], delay: "0s" }), import_react2.default.createElement(x2, { color: t2[1], delay: "1s" }), import_react2.default.createElement(x2, { color: t2[2], delay: "3s" }), import_react2.default.createElement(x2, { color: t2[3], delay: "2s" })));
var $2 = mt`
  0%, 100% {
...
`;
var u2 = dt.svg`
  width: ${(e2) => e2.size || "100px"};
  height: ${(e2) => e2.size || "100px"};
  fill: none;
  display: flex;
`;
var y2 = dt.path`
  animation: ${$2} ${(e2) => e2.speed || "2s"} ease-in-out
    infinite;
  animation-delay: ${(e2) => e2.delay || "0s"};
  fill: ${(e2) => e2.fill || "black"};
  opacity: ${(e2) => e2.opacity || "1"};
`;
function C2({ size: t2, color: n2, opacity: r3, speed: i2 }) {
  const a2 = n2 || ["#ffa9a1", "#FF6F61"];
  return import_react2.default.createElement(u2, { xmlns: "http://www.w3.org/2000/svg", width: t2 || "30", height: t2 || "26", viewBox: "0 0 30 26", fill: "none", size: t2 }, import_react2.default.createElement("g", { clipPath: "url(#clip0_395_73)" }, import_react2.default.createElement(y2, { d: "M-20.1557 23.1651L-22.4453 24.8897C-24.419 26.3763 -25.5797 28.7038 -25.5797 31.1747V49.1513C-25.5797 53.4969 -22.0568 57.0198 -17.7112 57.0198H177.69C182.035 57.0198 185.558 53.4969 185.558 49.1513V35.4992C185.558 33.2551 184.6 31.1178 182.925 29.6248L170.864 18.8764C168.17 16.4757 164.188 16.2151 161.204 18.2441L147.546 27.5318C144.981 29.2756 141.632 29.3505 138.992 27.7229L129.697 21.9924C127.336 20.5365 124.382 20.4316 121.924 21.7163L116.746 24.4218C113.56 26.0864 109.652 25.3807 107.249 22.7074L100.606 15.315C97.1909 11.5146 91.1157 11.9265 88.2447 16.1532L84.2741 21.9989C81.7837 25.6652 76.758 26.5523 73.163 23.9599L65.3646 18.3367C62.4675 16.2476 58.5267 16.3719 55.767 18.6395L48.0492 24.9813C45.3673 27.185 41.5583 27.371 38.6745 25.4392L34.8228 22.8589C31.9672 20.9459 28.2003 21.1079 25.5194 23.2588L24.128 24.3752C21.0483 26.8461 16.6143 26.652 13.7623 23.9214L11.6883 21.9356C8.71581 19.0897 4.0525 19.0148 0.990242 21.7639L-0.363153 22.9788C-3.13543 25.4676 -7.27311 25.671 -10.2762 23.4663L-10.765 23.1074C-13.5648 21.0518 -17.3813 21.0752 -20.1557 23.1651Z", fill: a2[0], speed: i2 || "2s", delay: "0s", opacity: r3 || 1 }), import_react2.default.createElement(y2, { d: "M-167.683 26.3393L-169.973 28.0639C-171.946 29.5506 -173.107 31.878 -173.107 34.3489V52.3255C-173.107 56.6711 -169.584 60.194 -165.238 60.194H30.1625C34.5082 60.194 38.031 56.6711 38.031 52.3255V38.6734C38.031 36.4294 37.0729 34.2921 35.3975 32.7991L23.3363 22.0507C20.6424 19.6499 16.6607 19.3893 13.6768 21.4184L0.0185394 30.706C-2.54597 32.4499 -5.89561 32.5247 -8.53546 30.8971L-17.8301 25.1666C-20.1915 23.7107 -23.1449 23.6058 -25.6036 24.8905L-30.7814 27.5961C-33.9669 29.2606 -37.8755 28.5549 -40.2779 25.8816L-46.921 18.4892C-50.3363 14.6888 -56.4115 15.1007 -59.2825 19.3274L-63.2531 25.1731C-65.7435 28.8395 -70.7692 29.7265 -74.3642 27.1342L-82.1626 21.5109C-85.0597 19.4218 -89.0005 19.5461 -91.7602 21.8138L-99.478 28.1555C-102.16 30.3592 -105.969 30.5453 -108.853 28.6134L-112.704 26.0331C-115.56 24.1202 -119.327 24.2821 -122.008 26.4331L-123.399 27.5494C-126.479 30.0203 -130.913 29.8262 -133.765 27.0956L-135.839 25.1098C-138.811 22.2639 -143.475 22.189 -146.537 24.9381L-147.89 26.1531C-150.663 28.6418 -154.8 28.8453 -157.803 26.6405L-158.292 26.2816C-161.092 24.226 -164.909 24.2495 -167.683 26.3393Z", fill: a2[1], speed: i2 || "2s", delay: "0.2s", opacity: r3 || 1 })), import_react2.default.createElement("defs", null, import_react2.default.createElement("clipPath", { id: "clip0_395_73" }, import_react2.default.createElement("rect", { width: "30", height: "26", rx: "13", fill: "white" }))));
}
C2.propTypes = { size: import_prop_types.default.string, color: import_prop_types.default.arrayOf(import_prop_types.default.string), opacity: import_prop_types.default.number, speed: import_prop_types.default.string };
var w2 = ({ size: r3 = 90, color1: i2 = "#FF6F61", color2: a2 = "#22333B", color3: o3 = "#ffa9a1", duration: l3 = 3 }) => {
  const [s3, p3] = (0, import_react2.useState)({}), [c3, m3] = (0, import_react2.useState)({}), [d2, h2] = (0, import_react2.useState)({});
  (0, import_react2.useEffect)(() => {
    p3({ animation: `morph1 ${l3}s infinite ease-in-out` }), m3({ animation: `morph2 ${l3}s infinite ease-in-out` }), h2({ animation: `morph3 ${l3}s infinite ease-in-out` });
  }, [l3]);
  const f3 = 4 * r3;
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement("style", null, `
          @keyframes morph1 {
            0%, 100% {
            ...
            33% {
              transform: translate(${1.66 * r3}px, -${1.11 * r3}px);
              width: ${0.66 * r3}px;
              height: ${0.66 * r3}px;
            } 
            66% {
              transform: translate(${1.11 * r3}px, ${1.11 * r3}px);
              width: ${1.55 * r3}px;
              height: ${1.55 * r3}px;
            }
          } 
        ...
        `), import_react2.default.createElement("div", { style: { position: "relative", width: `${f3}px`, height: 0.75 * f3 + "px", margin: "50px auto" } }, import_react2.default.createElement("div", { style: { position: "absolute", borderRadius: "50%", backgroundColor: i2, ...s3 } }), import_react2.default.createElement("div", { style: { position: "absolute", borderRadius: "50%", backgroundColor: a2, ...c3 } }), import_react2.default.createElement("div", { style: { position: "absolute", borderRadius: "50%", backgroundColor: o3, ...d2 } })));
};
w2.propTypes = { size: import_prop_types.default.number, color1: import_prop_types.default.string, color2: import_prop_types.default.string, color3: import_prop_types.default.string, duration: import_prop_types.default.number };
export {
  w2 as Circles,
  m2 as Dots,
  g2 as PulseBox,
...
//# sourceMappingURL=@holmesdev_ponder-spinners.js.map
